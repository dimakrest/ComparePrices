...
(function()
{
    ...
    var heb = {
        ...
        'PartialComparisonMade': 'ההשוואה נעשת על סמך רשימה חלקית של המוצרים',
        'ShowShopsThatPartiallySuit': 'המוצרים החסרים:',
        'HaveAllProducts': 'חנויות הכוללים את כל הסל',
        'FullyComparisonMade': 'ההשוואה נעשת על סמך רשימה מלאה של המוצרים',
